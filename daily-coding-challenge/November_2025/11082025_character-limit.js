/*
(November 08, 2025) Character Limit
...
=> long post
canPost("This message is too long to fit into either of the character limits for a social media post.")
=> invalid post
*/

function canPost(message) {
  if (message.length <= 40) return 'short post';
  else if (message.length <= 80) return 'long post';
